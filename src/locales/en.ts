...
export const en: typeof th = {
  ...
  home: {
    ...
    aiGeneratedLabel: "AI-generated recommendation",
    shortTermAdvice: "Short-term",
    longTermAdvice: "Long-term",
    tldrLabel: "Quick summary",
    viewFullAdvice: "View full advice",
    hideFullAdvice: "Hide full advice",
    getNewAdvice: "Get new advice",
    dailyActivitiesTitle: "Today's activity guide",
    dailyActivities: {
      outdoorExercise: "Outdoor exercise",
      openWindows: "Open windows for ventilation",
      childrenOutdoors: "Take young children outdoors",
      dryClothesOutdoors: "Dry clothes outdoors",
      longOutdoorActivities: "Long outdoor activities (over 1 hour)",
      wearMaskOutdoors: "Wear a mask outdoors",
    },
    refreshingAdvice: "Getting new advice...",
  ...
  map: {
    ...
    viewAiTrendGuidance: "View AI Trend Guidance",
    aiTrendGuidanceTitle: "AI Trend Guidance",
    aiTrendGuidanceDisclaimer:
      "This guidance was generated by AI using historical trends and is not an official forecast.",
    aiTrendGuidanceError: "AI trend guidance is temporarily unavailable — please try again later.",
    province: "Province",
    district: "District",
    address: "Address",
  ...
  leaderboard: {
    ...
    pageSubtitle: "Community-rated organizations and government agencies doing good for air quality",
    filterOrganizations: "Organizations",
    filterGovernment: "Government Agencies",
    averageRating: "Average rating",
    reviewerCount: "{count} reviewers",
    noRatingsYet: "No ratings yet",
    noOrganizations: "No organizations to show yet",
    noGovernment: "No government agencies to show yet",
    loadError: "Couldn't load the leaderboard right now. Please try again later",
    rateThisOrganization: "Rate this organization",
    rateThisGovernment: "Rate this government agency",
    yourRating: "Your rating",
    submitRating: "Submit rating",
    ratingSubmitted: "Rating submitted — thanks!",
    ratingFailed: "Couldn't submit your rating. Please try again",
    loginToRate: "Log in to rate this organization",
    loginToRateGovernment: "Log in to rate this government agency",
    cannotRateSelf: "You can't rate your own organization account",
    cannotRateSelfGovernment: "You can't rate your own government account",
  ...
  alerts: {
    ...
    knowledgeLoadError: "Couldn't load knowledge articles right now",
    knowledgeEmpty: "No knowledge articles yet",
    readFullKnowledge: "Read full article",
    showLess: "Show less",
    searchPlaceholder: "Search news...",
    filterAll: "All",
    filterPm25: "PM2.5",
    filterHealth: "Health",
    filterLaws: "Laws/Announcements",
    ...
    legalWarningNationalTag: "National-level legal information",
    legalWarningTitle: "Open burning is illegal — maximum penalty up to 20 years in prison",
    legalWarningBody:
      "Under Thai law, illegal open burning carries serious penalties — burning in forest and protected areas carries the harshest tier, with fines of up to 2,000,000 THB, imprisonment of up to 20 years, or both. Exact penalties vary by location and circumstances. (National-level information, per the Pollution Control Department)",
    legalWarningSourceLabel: "View source (Government Public Relations Dept.)",
    provincialRegulationLabel: "{province}-specific regulation",
  ...
  profile: {
    ...
    saveButton: "Save",
    saving: "Saving...",
    savedConfirmation: "Saved — you can update and save again anytime.",
