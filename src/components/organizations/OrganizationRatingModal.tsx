        ...
        {isSelf ? (
          ...
          <div className="flex flex-col items-center gap-3 rounded-xl border border-gray-100 p-3">
            <p className="text-sm font-semibold text-gray-700">
              {myRating ? t("leaderboard.yourRating") : t("leaderboard.rateThisOrganization")}
            </p>
